...
declare_id!("HZ358WoBLQHMCyTGd1xcTy2zvnhXKc5X1jJVqoreZV19");
...
pub mod solana_multisig {
    ...
    pub fn create_transfer(ctx: Context<Auth>, to: Pubkey , amount: u64) -> Results<()> {
        // check if we have a valid "to" address and amount
        // create transfer
        Ok(())
    }
